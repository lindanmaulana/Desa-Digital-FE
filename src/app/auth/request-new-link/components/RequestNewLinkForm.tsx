...
import type { TypeResendVerifyTokenSchema } from '@/lib/validation/auth.validation';
import type { AuthFormSubmissingProps } from '@/types/auth.types';
import { Mail } from 'lucide-react';

export const RequestNewLinkForm = ({formMethods, handleForm, isPending}: AuthFormSubmissingProps<TypeResendVerifyTokenSchema>) => {
